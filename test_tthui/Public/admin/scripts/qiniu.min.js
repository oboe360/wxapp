    ...
    function() { !
        function(e, t) {
            ...
            function() {
                ...
                function c(t, i) {
                    function n(o) {
                        "function" === e(t[o]) && t[o](function(e) {++o < r && !e ? n(o) : i(e)
                        })
                    }
                    var r = t.length;
            ...
            n("moxie/core/utils/Env", ["moxie/core/utils/Basic"],
            function(e) {
                function t(e, t, i) {
                    var n = 0,
                    r = 0,
                ...
                var i = function(e) {
                    ...
                    r = {
                        rgx: function() {
                            for (var e, t, i, n, r, o, s, a = 0,
                            u = arguments; a < u.length; a += 2) {
                                var l = u[a],
                                c = u[a + 1];
                                if (void 0 === e) {
                                    e = {};
                ...
                o.log = function() {
                    ...
                    if ("string" === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log) window.console.log(t);
                        ...
                        -1 !== e.inArray(e.typeOf(t), ["object", "array"]) ?
                        function(e) {
            ...
            n("moxie/core/Exceptions", ["moxie/core/utils/Basic"],
            function(e) {
                function t(e, t) {
                    var i;
            ...
            n("moxie/core/utils/Dom", ["moxie/core/utils/Env"],
            function(e) {
                var t = function(e) {
                ...
                return {
                    ...
                    getPos: function(t, i) {
                        ...
                        for (r = t; r && r != i && r.nodeType;) a += r.offsetLeft || 0,
                        u += r.offsetTop || 0,
                        r = r.offsetParent;
                        for (r = t.parentNode; r && r != i && r.nodeType;) a -= r.scrollLeft || 0,
                        u -= r.scrollTop || 0,
                        r = r.parentNode;
                        return {
                            x: a,
            ...
            n("moxie/core/EventTarget", ["moxie/core/utils/Env", "moxie/core/Exceptions", "moxie/core/utils/Basic"],
            function(e, t, i) {
                function n() {
                    this.uid = i.guid()
                }
                ...
                return i.extend(n.prototype, {
                    ...
                    addEventListener: function(e, t, n, o) {
                        var s, a = this;
                        if (this.hasOwnProperty("uid") || (this.uid = i.guid("uid_")), e = i.trim(e), /\s/.test(e)) return void i.each(e.split(/\s+/),
                        function(e) {
                    ...
                    removeEventListener: function(e, t) {
                        var n, o, s = this;
                        if (e = e.toLowerCase(), /\s/.test(e)) return void i.each(e.split(/\s+/),
                        function(e) {
            ...
            n("moxie/runtime/Runtime", ["moxie/core/utils/Env", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/EventTarget"],
            function(e, t, i, n) {
                        ...
                        function(n, r) {
                            if (i.hasOwnProperty(r)) {
                                ...
                                if ("string" == typeof a && (a = [a]), o) {
                                    if (! (o = t.arrayIntersect(o, a))) return s && e.debug.runtime && e.log("\t\t%c: %v (conflicting mode requested: %s)", r, n, a),
                                    o = !1
                                } else o = a
                            }
            ...
            n("moxie/runtime/RuntimeClient", ["moxie/core/utils/Env", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/runtime/Runtime"],
            function(e, t, i, n) {
                return function() {
                    var r;
                    i.extend(this, {
                        connectRuntime: function(o) {
                            function a(i) {
                                var u, c;
                                return i.length ? (u = i.shift().toLowerCase(), (c = n.getConstructor(u)) ? (s && e.debug.runtime && (e.log("Trying runtime: %s", u), e.log(o)), r = new c(o), r.bind("Init",
                                function() {
                                    r.initialized = !0,
            ...
            n("moxie/file/Blob", ["moxie/core/utils/Basic", "moxie/core/utils/Encode", "moxie/runtime/RuntimeClient"],
            function(e, t, i) {
                function n(o, s) {
                    function a(t, i, o) {
                        var s, a = r[this.uid];
            ...
            n("moxie/core/I18n", ["moxie/core/utils/Basic"],
            function(e) {
                var t = {};
                return {
                    addI18n: function(i) {
            ...
            n("moxie/core/utils/Mime", ["moxie/core/utils/Basic", "moxie/core/I18n"],
            function(e, t) {
                var i = {
                    mimes: {},
                    extensions: {},
            ...
            n("moxie/file/FileInput", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Mime", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/I18n", "moxie/runtime/Runtime", "moxie/runtime/RuntimeClient"],
            function(e, t, i, n, r, o, a, u, l) {
                function c(o) {
                        ...
                        init: function() {
                            ...
                            function(i, r) {
                                ...
                                function() {
                                    ...
                                    a = n.get(r.shimid),
                                    s && (t = n.getPos(s, n.get(o.container)), i = n.getSize(s), u = parseInt(n.getStyle(s, "z-index"), 10) || 0, a && e.extend(a.style, {
                                        top: t.y + "px",
                                        left: t.x + "px",
                                        width: i.w + "px",
                                        height: i.h + "px",
            ...
            n("moxie/file/File", ["moxie/core/utils/Basic", "moxie/core/utils/Mime", "moxie/file/Blob"],
            function(e, t, i) {
                function n(n, r) {
                    r || (r = {}),
            ...
            n("moxie/file/FileDrop", ["moxie/core/I18n", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/file/File", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget", "moxie/core/utils/Mime"],
            function(e, t, i, n, r, o, a, u, l) {
                function c(i) {
            ...
            n("moxie/file/FileReader", ["moxie/core/utils/Basic", "moxie/core/utils/Encode", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/file/Blob", "moxie/runtime/RuntimeClient"],
            function(e, t, i, n, r, o) {
                function s() {
                    function n(e, n) {
                        if (this.trigger("loadstart"), this.readyState === s.LOADING) return this.trigger("error", new i.DOMException(i.DOMException.INVALID_STATE_ERR)),
                    ...
                    e.extend(this, {
                        ...
                        abort: function() {
                            this.result = null,
                            -1 === e.inArray(this.readyState, [s.EMPTY, s.DONE]) && (this.readyState === s.LOADING && (this.readyState = s.DONE), this.exec("FileReader", "abort"), this.trigger("abort"), this.trigger("loadend"))
                        },
                        destroy: function() {
                            this.abort(),
            ...
            n("moxie/core/utils/Url", ["moxie/core/utils/Basic"],
            function(e) {
                var t = function(i, n) {
                    ...
                    if (r = !d && !u.scheme, (d || r) && (u.scheme = n.scheme), r) {
                        ...
                        u.port = n.port;
                        var p = "";
                        /^[^\/]/.test(u.path) && (p = n.path, p = /\/[^\/]*\.[^\/]*$/.test(p) ? p.replace(/\/[^\/]+$/, "/") : p.replace(/\/?$/, "/")),
                        u.path = p + (u.path || "")
                    }
            ...
            n("moxie/runtime/RuntimeTarget", ["moxie/core/utils/Basic", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget"],
            function(e, t, i) {
                function n() {
            ...
            n("moxie/file/FileReaderSync", ["moxie/core/utils/Basic", "moxie/runtime/RuntimeClient", "moxie/core/utils/Encode"],
            function(e, t, i) {
                return function() {
                    function n(e, t) {
                        if (!t.isDetached()) {
            ...
            n("moxie/xhr/FormData", ["moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/file/Blob"],
            function(e, t, i) {
                function n() {
                    var e, n = [];
                    t.extend(this, {
            ...
            n("moxie/xhr/XMLHttpRequest", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/utils/Encode", "moxie/core/utils/Url", "moxie/runtime/Runtime", "moxie/runtime/RuntimeTarget", "moxie/file/Blob", "moxie/file/FileReaderSync", "moxie/xhr/FormData", "moxie/core/utils/Env", "moxie/core/utils/Mime"],
            function(e, t, i, n, r, o, s, a, u, l, c, d) {
                function p() {
                    this.uid = e.guid("uid_")
                }
                function f() {
                    ...
                    function u(t) {
                        ...
                        function r(r) {
                            ...
                            b.bind("Progress",
                            function(e) {
                                i("readyState") !== f.LOADING && (i("readyState", f.LOADING), a.dispatchEvent("readystatechange")),
                                a.dispatchEvent(e)
                            }),
                            ...
                            function(t) {
                                ...
                                a.dispatchEvent("readystatechange"),
                                i("status") > 0 ? (F && a.upload.dispatchEvent(t), a.dispatchEvent(t)) : (k = !0, a.dispatchEvent("error")),
                                n()
                            }),
                            b.bind("Abort",
                            function(e) {
                        ...
                        z.ruid ? r(b.connectRuntime(z)) : (b.bind("RuntimeInit",
                        function(e, t) {
                            r(t)
                        }), b.bind("RuntimeError",
                        function(e, t) {
                    ...
                    e.extend(this, S, {
                        ...
                        send: function(i, r) {
                            ...
                            this.readyState !== f.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                            if (i instanceof a) z.ruid = i.ruid,
            ...
            n("moxie/runtime/Transporter", ["moxie/core/utils/Basic", "moxie/core/utils/Encode", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget"],
            function(e, t, i, n) {
                function r() {
                    function n() {
                        c = d = 0,
                    ...
                    function o(t, i) {
                        var n = this;
                        u = i,
                        n.bind("TransportingProgress",
                        function(t) { (d = t.loaded) < c && -1 === e.inArray(n.state, [r.IDLE, r.DONE]) && s.call(n)
                        },
                        999),
            ...
            n("moxie/runtime/html5/Runtime", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/Runtime", "moxie/core/utils/Env"],
            function(e, t, i, n) {
                function o(t) {
                    var o = this,
                    u = i.capTest,
            ...
            n("moxie/runtime/html5/file/Blob", ["moxie/runtime/html5/Runtime", "moxie/file/Blob"],
            function(e, t) {
                function i() {
                    function e(e, t, i) {
                        var n;
            ...
            function(e) {
                ...
                o = function(o, s, a, u) {
                    var l, c;
                    s = s.toLowerCase(),
                    o.addEventListener ? (l = a, o.addEventListener(s, l, !1)) : o.attachEvent && (l = function() {
                        var e = window.event;
            ...
            n("moxie/runtime/html5/file/FileInput", ["moxie/runtime/html5/Runtime", "moxie/file/File", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Mime", "moxie/core/utils/Env"],
                ...
                function a() {
                    ...
                    i.extend(this, {
                        init: function(u) {
                            ...
                            g.can("summon_file_dialog") && ("static" === n.getStyle(p, "position") && (p.style.position = "relative"), r.addEvent(p, "click",
                            function(e) {
                                var t = n.get(g.uid);
                                t && !t.disabled && t.click(),
                                e.preventDefault()
                            },
                            m.uid), m.bind("Refresh",
                            function() {
                                f = parseInt(a, 10) || 1,
                            ...
                            r.addEvent(h, "mouseover",
                            function() {
                                m.trigger("mouseenter")
                            },
                            m.uid),
                            r.addEvent(h, "mouseout",
                            function() {
                                m.trigger("mouseleave")
                            },
                            m.uid),
                            r.addEvent(h, "mousedown",
                            function() {
                                m.trigger("mousedown")
                            },
                            m.uid),
                            r.addEvent(n.get(e.container), "mouseup",
                            function() {
                                m.trigger("mouseup")
                            },
                            m.uid),
                            l.onchange = function n(r) {
                                if (m.files = [], i.each(this.files,
                                function(i) {
                                    var n = "";
                        ...
                        disable: function(e) {
                            var t, i = this.getRuntime(); (t = n.get(i.uid)) && (t.disabled = !!e)
                        },
                        destroy: function() {
                            var t = this.getRuntime(),
                            i = t.getShim(),
            ...
            n("moxie/runtime/html5/file/FileDrop", ["moxie/runtime/html5/Runtime", "moxie/file/File", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Mime"],
            function(e, t, i, n, r, o) {
                function s() {
                    function e(e) {
                    ...
                    i.extend(this, {
                        init: function(t) {
                            ...
                            r.addEvent(n, "drop",
                            function(t) {
                                e(t) && (t.preventDefault(), m = [], t.dataTransfer.items && t.dataTransfer.items[0].webkitGetAsEntry ? l(t.dataTransfer.items,
                                function() {
                                    o.files = m,
                                    o.trigger("drop")
                                }) : (i.each(t.dataTransfer.files,
                                function(e) {
                                    s(e)
            ...
            n("moxie/runtime/html5/file/FileReader", ["moxie/runtime/html5/Runtime", "moxie/core/utils/Encode", "moxie/core/utils/Basic"],
            function(e, t, i) {
                function n() {
                    function e(e) {
            ...
            n("moxie/runtime/html5/xhr/XMLHttpRequest", ["moxie/runtime/html5/Runtime", "moxie/core/utils/Basic", "moxie/core/utils/Mime", "moxie/core/utils/Url", "moxie/file/File", "moxie/file/Blob", "moxie/xhr/FormData", "moxie/core/Exceptions", "moxie/core/utils/Env"],
                ...
                function l() {
                    ...
                    t.extend(this, {
                        send: function(i, r) {
                            ...
                            m = !1;
                            if (f = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), p = l(), p.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (m = !0),
                            r = r.getSource();
                            else if (r instanceof s) {
                                if (r.hasBlob()) if (r.getBlob().isDetached()) r = d.call(a, r),
                                m = !0;
                            ...
                            p.upload ? (i.withCredentials && (p.withCredentials = !0), p.addEventListener("load",
                            function(e) {
                                a.trigger(e)
            ...
            n("moxie/runtime/html5/utils/BinaryReader", ["moxie/core/utils/Basic"],
            function(e) {
                function t(e) {
            ...
            n("moxie/runtime/html5/image/JPEGHeaders", ["moxie/runtime/html5/utils/BinaryReader", "moxie/core/Exceptions"],
            function(e, t) {
                return function i(n) {
                    var r, o, s, a = [],
                    u = 0;
                    ...
                    for (o = 2; o <= r.length();) if ((s = r.SHORT(o)) >= 65488 && s <= 65495) o += 2;
                    else {
                    ...
                    return r.clear(),
                    {
                        ...
                        restore: function(t) {
                            var i, n, r;
                            for (r = new e(t), o = 65504 == r.SHORT(2) ? 4 + r.SHORT(4) : 2, n = 0, i = a.length; n < i; n++) r.SEGMENT(o, 0, a[n].segment),
                            o += a[n].length;
                            return t = r.SEGMENT(),
                            r.clear(),
                            t
            ...
            n("moxie/runtime/html5/image/ExifParser", ["moxie/core/utils/Basic", "moxie/runtime/html5/utils/BinaryReader", "moxie/core/Exceptions"],
            function(e, i, n) {
                function r(o) {
                    function s(i, r) {
            ...
            n("moxie/runtime/html5/image/JPEG", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/html5/image/JPEGHeaders", "moxie/runtime/html5/utils/BinaryReader", "moxie/runtime/html5/image/ExifParser"],
            function(e, t, i, n, r) {
                function o(o) {
                    function s(e) {
                        var t, i, n = 0;
            ...
            n("moxie/runtime/html5/image/PNG", ["moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/runtime/html5/utils/BinaryReader"],
            function(e, t, i) {
                function n(n) {
                    function r() {
                        var e, t;
            ...
            n("moxie/runtime/html5/image/ImageInfo", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/html5/image/JPEG", "moxie/runtime/html5/image/PNG"],
            function(e, t, i, n) {
                return function(r) {
                    var o, s = [i, n];
                    o = function() {
            ...
            n("moxie/runtime/html5/image/Image", ["moxie/runtime/html5/Runtime", "moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/core/utils/Encode", "moxie/file/Blob", "moxie/file/File", "moxie/runtime/html5/image/ImageInfo", "moxie/runtime/html5/image/ResizerCanvas", "moxie/core/utils/Mime", "moxie/core/utils/Env"],
            function(e, t, i, n, r, o, s, a, u, l) {
                function c() {
                    function e() {
            ...
            n("moxie/runtime/flash/Runtime", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/runtime/Runtime"],
            function(e, t, i, n, o) {
                function a() {
                    var e;
                    try {
                ...
                function c(l) {
                    ...
                    "client"),
                    a() < 11.3 && (s && t.debug.runtime && t.log("\tFlash didn't meet minimal version requirement (11.3)."), this.mode = !1),
                    e.extend(this, {
                        getShim: function() {
            ...
            n("moxie/runtime/flash/file/Blob", ["moxie/runtime/flash/Runtime", "moxie/file/Blob"],
            function(e, t) {
                var i = {
            ...
            n("moxie/runtime/flash/file/FileInput", ["moxie/runtime/flash/Runtime", "moxie/file/File", "moxie/core/utils/Basic"],
            function(e, t, i) {
                var n = {
                    init: function(e) {
                        var n = this,
            ...
            n("moxie/runtime/flash/file/FileReader", ["moxie/runtime/flash/Runtime", "moxie/core/utils/Encode"],
            function(e, t) {
                function i(e, i) {
                    switch (i) {
                    case "readAsText":
            ...
            n("moxie/runtime/flash/file/FileReaderSync", ["moxie/runtime/flash/Runtime", "moxie/core/utils/Encode"],
            function(e, t) {
                function i(e, i) {
                    switch (i) {
                    case "readAsText":
            ...
            n("moxie/runtime/flash/runtime/Transporter", ["moxie/runtime/flash/Runtime", "moxie/file/Blob"],
            function(e, t) {
                var i = {
            ...
            n("moxie/runtime/flash/xhr/XMLHttpRequest", ["moxie/runtime/flash/Runtime", "moxie/core/utils/Basic", "moxie/file/Blob", "moxie/file/File", "moxie/file/FileReaderSync", "moxie/runtime/flash/file/FileReaderSync", "moxie/xhr/FormData", "moxie/runtime/Transporter", "moxie/runtime/flash/runtime/Transporter"],
            function(e, t, i, n, r, o, s, a, u) {
                var l = {
                    send: function(e, n) {
                        function r() {
                        ...
                        function(e, t) {
                            ...
                            r()
                        } else n instanceof i ? n.isDetached() ? u(n,
                        function(e) {
                            n.destroy(),
                            n = e.uid,
                            r()
            ...
            n("moxie/runtime/flash/image/Image", ["moxie/runtime/flash/Runtime", "moxie/core/utils/Basic", "moxie/runtime/Transporter", "moxie/file/Blob", "moxie/file/FileReaderSync"],
            function(e, t, i, n, r) {
                var o = {
                    loadFromBlob: function(e) {
                        function t(e) {
            ...
            n("moxie/runtime/silverlight/Runtime", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/runtime/Runtime"],
            function(e, t, i, n, o) {
                function a(e) {
                    var t, i, n, r, o, s = !1,
                    a = null,
                ...
                function u(u) {
                    ...
                    a("2.0.31005.0") && "Opera" !== t.browser || (s && t.debug.runtime && t.log("\tSilverlight is not installed or minimal version (2.0.31005.0) requirement not met (not likely)."), this.mode = !1),
                    e.extend(this, {
                        getShim: function() {
            ...
            n("moxie/runtime/silverlight/file/Blob", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/Blob"],
            function(e, t, i) {
                return e.Blob = t.extend({},
                i)
            }),
            n("moxie/runtime/silverlight/file/FileInput", ["moxie/runtime/silverlight/Runtime", "moxie/file/File", "moxie/core/utils/Basic"],
            function(e, t, i) {
                function n(e) {
                    for (var t = "",
            ...
            n("moxie/runtime/silverlight/file/FileDrop", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Dom", "moxie/core/utils/Events"],
            function(e, t, i) {
                var n = {
                    init: function() {
                        var e, n = this,
            ...
            n("moxie/runtime/silverlight/file/FileReader", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/FileReader"],
            function(e, t, i) {
                return e.FileReader = t.extend({},
                i)
            }),
            n("moxie/runtime/silverlight/file/FileReaderSync", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/FileReaderSync"],
            function(e, t, i) {
                return e.FileReaderSync = t.extend({},
                i)
            }),
            n("moxie/runtime/silverlight/runtime/Transporter", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/runtime/Transporter"],
            function(e, t, i) {
            ...
            n("moxie/runtime/silverlight/image/Image", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/file/Blob", "moxie/runtime/flash/image/Image"],
            function(e, t, i, n) {
                ...
                n, {
                    getInfo: function() {
                        ...
                        return o.meta && (t.each(n,
                        function(e) {
                            var t, i, n, s, a = o.meta[e];
                            if (a && a.keys) for (r.meta[e] = {},
                            i = 0, n = a.keys.length; i < n; i++) t = a.keys[i],
                            (s = a[t]) && (/^(\d|[1-9]\d+)$/.test(s) ? s = parseInt(s, 10) : /^\d*\.\d+$/.test(s) && (s = parseFloat(s)), r.meta[e][t] = s)
            ...
            n("moxie/runtime/html4/Runtime", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/Runtime", "moxie/core/utils/Env"],
            function(e, t, i, n) {
                function o(t) {
                    var o = this,
                    u = i.capTest,
            ...
            n("moxie/runtime/html4/file/FileInput", ["moxie/runtime/html4/Runtime", "moxie/file/File", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Mime", "moxie/core/utils/Env"],
            function(e, t, i, n, r, o, s) {
                function a() {
                    function e() {
                        ...
                        g.can("summon_file_dialog") && (l = n.get(u.browse_button), r.removeEvent(l, "click", m.uid), r.addEvent(l, "click",
                        function(e) {
                    ...
                    i.extend(this, {
                        init: function(t) {
                            ...
                            function() {
                                ...
                                a.can("summon_file_dialog") && ("static" === n.getStyle(e, "position") && (e.style.position = "relative"), s.bind("Refresh",
                                function() {
                                    o = parseInt(l, 10) || 1,
                                ...
                                r.addEvent(c, "mouseover",
                                function() {
                                    s.trigger("mouseenter")
                                },
                                s.uid),
                                r.addEvent(c, "mouseout",
                                function() {
                                    s.trigger("mouseleave")
                                },
                                s.uid),
                                r.addEvent(c, "mousedown",
                                function() {
                                    s.trigger("mousedown")
                                },
                                s.uid),
                                r.addEvent(n.get(t.container), "mouseup",
                                function() {
                                    s.trigger("mouseup")
                                },
                                s.uid),
            ...
            n("moxie/runtime/html4/file/FileReader", ["moxie/runtime/html4/Runtime", "moxie/runtime/html5/file/FileReader"],
            function(e, t) {
                return e.FileReader = t
            }),
            n("moxie/runtime/html4/xhr/XMLHttpRequest", ["moxie/runtime/html4/Runtime", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Url", "moxie/core/Exceptions", "moxie/core/utils/Events", "moxie/file/Blob", "moxie/xhr/FormData"],
                            ...
                            function() {
                                ...
                                function() {
                                    ...
                                    try {
                                        ...
                                        if (!n.hasSameOrigin(d.url)) return void e.call(v,
                                        function() {
                                            v.trigger("error")
                                        });
                                        u = 404
            ...
            n("moxie/runtime/html4/image/Image", ["moxie/runtime/html4/Runtime", "moxie/runtime/html5/image/Image"],
            function(e, t) {
                return e.Image = t
            }),
            function(i) {
                for (var n = 0; n < i.length; n++) {
                    for (var r = e,
                    o = i[n], s = o.split(/[.\/]/), u = 0; u < s.length - 1; ++u) r[s[u]] === t && (r[s[u]] = {}),
                    r = r[s[u]];
                    r[s[s.length - 1]] = a[o]
                }
    ...
    function(e) { !
        function(e, t, i) {
            function n(e) {
                ...
                n = {};
                return "string" == typeof i ? u.each(i.split(/\s*,\s*/),
                function(e) {
                    t(e, !0)
                }) : "object" == typeof i ? u.each(i,
                function(e, i) {
                    t(i, e)
                }) : !0 === i && (e.chunk_size && e.chunk_size > 0 && (n.slice_blob = !0), u.isEmptyObj(e.resize) && !1 !== e.multipart || (n.send_binary_string = !0), e.http_method && (n.use_http_method = e.http_method), u.each(e,
                function(e, i) {
                    t(i, !!e, !0)
                })),
                n
            ...
            u.addFileFilter("prevent_duplicates",
            function(e, t, i) {
            ...
            u.Uploader = function(e) {
                ...
                function c() {
                    ...
                    t.size !== i ? (A.size += t.origSize, n = t.loaded * t.origSize / t.size, (!t.completeTimestamp || t.completeTimestamp > S) && (r += n), A.loaded += n) : A.size = i,
                ...
                function h(e, i) {
                    ...
                    u.each(e.runtimes.split(/\s*,\s*/),
                    function(t) {
                        e[t] && (s[t] = e[t])
                    }),
                    e.browse_button && u.each(e.browse_button,
                    function(i) {
                        o.push(function(o) {
                            ...
                            l.bind("mouseenter mouseleave mousedown mouseup",
                            function(t) {
                    ...
                    e.drop_element && u.each(e.drop_element,
                    function(e) {
                        o.push(function(i) {
                ...
                function g(e, i, r) {
                    ...
                    var s = this,
                    l = !1;
                    "object" == typeof e ? u.each(e,
                    function(e, t) {
                        o(t, e, r)
                    }) : o(e, i, r),
                    r ? (T.required_features = n(u.extend({},
                    T)), C = n(u.extend({},
                    T, {
                        required_features: !0
                    }))) : l && (s.trigger("Destroy"), h.call(s, T,
                    function(e) {
                ...
                function x(e, i) {
                    ...
                    function s(s, c, p) {
                        ...
                        I.onload = function() {
                            ...
                            p < a.size ? (c.destroy(), h += p, i.loaded = Math.min(h, a.size), e.trigger("ChunkUploaded", i, {
                                offset: i.loaded,
                                total: a.size,
                                response: I.responseText,
                                status: I.status,
                            ...
                            c = m = null,
                            !h || h >= a.size ? (i.size != i.origSize && (a.destroy(), a = null), e.trigger("UploadProgress", i), i.status = u.DONE, i.completeTimestamp = +new Date, e.trigger("FileUploaded", i, {
                                response: I.responseText,
                                status: I.status,
                                responseHeaders: I.getAllResponseHeaders()
                            })) : r(o, 1)
                        ...
                        e.settings.multipart && f.multipart ? (I.open(e.settings.http_method, l, !0), u.each(e.settings.headers,
                        function(e, t) {
                            I.setRequestHeader(t, e)
                        }), m = new t.xhr.FormData, u.each(u.extend(s, e.settings.multipart_params),
                        function(e, t) {
                            m.append(t, e)
                        ...
                        })) : (l = u.buildUrl(e.settings.url, u.extend(s, e.settings.multipart_params)), I.open(e.settings.http_method, l, !0), u.each(e.settings.headers,
                        function(e, t) {
                            I.setRequestHeader(t, e)
                    ...
                    a = i.getSource(),
                    !u.isEmptyObj(e.settings.resize) && p(a, "send_binary_string") && -1 !== u.inArray(a.type, ["image/jpeg", "image/png"]) ? m.call(this, a, e.settings.resize,
                    function(e) {
                        a = e,
                        i.size = e.size,
                        o()
                ...
                u.extend(this, {
                    ...
                    init: function() {
                        ...
                        "function" == typeof e ? e(i) : u.each(e,
                        function(e, t) {
                            i.bind(t, e)
                        }),
                        f.call(i),
                        u.each(["container", "browse_button", "drop_element"],
                        function(e) {
                        ...
                        t ? i.trigger("Error", t) : T.browse_button || T.drop_element ? void h.call(i, T,
                        function(e) {
                            var t = i.getOption("init");
                            "function" == typeof t ? t(i) : u.each(t,
                            function(e, t) {
                                i.bind(t, e)
                            }),
                    ...
                    addFile: function(e, i) {
                        ...
                        function s(e) {
                            ...
                            if (e instanceof t.file.File) {
                                ...
                                n(e,
                                function(i) {
                                    i || (D.push(e), p.push(e), l.trigger("FileFiltered", e)),
                                    r(t, 1)
                                })
                    ...
                    splice: function(e, t) {
                        ...
                        r = !1;
                        return this.state == u.STARTED && (u.each(n,
                        function(e) {
...
function(module, exports, __webpack_require__) {
    ...
    function(global) {
        ...
        function readCookie(e) {
            for (var t = e + "=",
            i = document.cookie.split(";"), n = 0, r = i.length; n < r; n++) {
                for (var o = i[n];
        ...
        function QiniuJsSDK() {
            function log(e, t) {
                for (var i = "[qiniu-js-sdk][" + e + "]",
                n = i,
                r = 0; r < t.length; r++)"string" == typeof t[r] ? n += " " + t[r] : n += " " + that.stringifyJSON(t[r]);
            ...
            function StatisticsLogger() {
                function e() {
                    for (var e = [], i = 0; i < n.length; i++) n[i].status !== r.finished && e.push(n[i]),
            ...
            this.detectIEVersion = function() {
                for (var e = 4,
                t = document.createElement("div"), i = t.getElementsByTagName("i"); t.innerHTML = "\x3c!--[if gt IE " + e + "]><i></i><![endif]--\x3e", i[0];) e++;
                return e > 4 && e
            };
            var logger = {
                MUTE: 0,
            ...
            this.uploader = function(e) {
                ...
                i = function(i) {
                    ...
                    s && s <= 9 ? (o = new moxie.xhr.XMLHttpRequest, moxie.core.utils.Env.swf_url = e.flash_swf_url) : o = that.createAjax(),
                    o.open("GET", r, !1);
                    var a = function() {
                ...
                h && h <= 9 && (f.multipart_params.accept = "text/plain; charset=utf-8", logger.debug("add accept text/plain in multipart params")),
                ...
                function(t, i) {
                    ...
                    var s = function(t, i, n) {
                        ...
                        s && s <= 9 && (r.accept = "text/plain; charset=utf-8", logger.debug("add accept text/plain in multipart params")),
                    ...
                    else if (i.size < u || a()) logger.debug("directUpload because file.size < chunk_size || is_android_weixin_or_qq()"),
                    s(t, i, that.key_handler);
                    else {
                ...
                function(t) {
                    return function(i, n, r) {
                        ...
                        if (d = d || c.ctx, logger.debug("ctx: ", d), d) {
                            ...
                            e.save_key || (p = o(i, n, that.key_handler), p = p ? "/key/" + that.URLSafeBase64Encode(p) : "");
        ...
        void 0 !== module && module.exports ? module.exports = QiniuJsSDK: (__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1)], void 0 !== (__WEBPACK_AMD_DEFINE_RESULT__ = function() {
            return QiniuJsSDK
