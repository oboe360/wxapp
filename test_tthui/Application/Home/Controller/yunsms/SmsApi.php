...
class SmsApi {
    ...
    public function sendSms($signName, $templateCode, $phoneNumbers, $templateParam = null, $outId = null, $smsUpExtendCode = null) {
        ...
        public function sendSms2( $templateCode, $uid, $templateParam = null, $outId = null, $smsUpExtendCode = null) {
        $signName = "环球美淘";

        $user_phone  = $GLOBALS['db']->getOne("select user_name from ecs_users where user_id = ".$uid);
        $name_type = substr($user_phone, 0, 2);
        if($name_type == 'wx'){
            $smsinfosql = "select user_name,address_id  from ecs_users where user_id = ".$uid;
            $smsinfo = $GLOBALS['db']->getRow($smsinfosql);
            $phoneNumbers  = $GLOBALS['db']->getOne("select tel from ecs_user_address where address_id = '".$smsinfo['address_id']."'");           
        }else{
   ...
   public function sendSms3( $templateCode, $phoneNumbers, $templateParam = null, $outId = null, $smsUpExtendCode = null) {
